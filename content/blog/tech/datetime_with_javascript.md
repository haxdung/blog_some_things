+++
title = "Xử lý datetime trong javascript cùng moment"
description = "Moment là 1 thư viện xử lý datetime cực kỳ mạnh mẽ do cộng đồng viết ra. Hầu hết các xử lý datetime giờ đây sẽ trở lên dễ dàng hơn bao giờ hết với supper library này."
author = "DungHX"
date = "2020-08-28"
tags = ["javascript", "datetime", "moment js"]
categories = ["javascript"]
comments = true
removeBlur = false
[[images]]
  src = "img/2020/tech/datetime_with_javascript.png"
  alt = "Xử lý datetime trong javascript cùng moment"
  stretch = "horizontal"
+++
